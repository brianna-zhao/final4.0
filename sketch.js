...
function draw() {
  ...
  if (gameStatus == "before") {
    ...
    text("TERRIBLE cat owner!", 0, 100, width, 40);
  } else if (gameStatus == "success") {
    image(successImg, width / 2 - 144, height / 2 - 142, 288, 284);
    fill(0);
    textSize(32);
    text("You're not stupid ", 0, 100, width, 40);
  }
}
...
function match3() {
  ...
  let rowCount = currentIndex == 0 ? 3 : 4;
